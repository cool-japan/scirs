...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    use scirs2_neural::callbacks::{Callback, CallbackContext, CallbackTiming, ScirsMetricsCallback};
    ...
    println!("\nStart training for {} epochs with batch size {}:", num_epochs, batch_size);
    ...
    for epoch in 0..num_epochs {
        ...
        if let Some(cb) = metrics_callback.as_mut() {
            ...
            println!("Epoch {}/{}: loss = {:.4}", epoch + 1, num_epochs, epoch_loss);
