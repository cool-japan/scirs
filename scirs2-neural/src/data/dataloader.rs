...
pub struct DataLoader<F: Float + Debug + ScalarOperand, D: Dataset<F>> {
...
impl<F: Float + Debug + ScalarOperand, D: Dataset<F>> DataLoader<F, D> {
...
impl<F: Float + Debug + ScalarOperand, D: Dataset<F>> Iterator for DataLoader<F, D> {
...
pub fn iter_batches<F: Float + Debug + ScalarOperand, D: Dataset<F>>(
    dataset: D,
    batch_size: usize,
    shuffle: bool,
    drop_last: bool,
