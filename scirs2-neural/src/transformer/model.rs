...
pub struct Transformer<F: Float + Debug> {
...
impl<F: Float + Debug + ScalarOperand + 'static> Transformer<F> {
...
impl<F: Float + Debug + ScalarOperand + 'static> Layer<F> for Transformer<F> {
