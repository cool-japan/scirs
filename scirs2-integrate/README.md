...
**Numerical integration, ODE/PDE/SDE solvers, and physics simulation for the SciRS2 scientific computing library (v0.4.4).**
...
```toml
[dependencies]
scirs2-integrate = { version = "0.4.4", features = ["parallel", "simd"] }
```
