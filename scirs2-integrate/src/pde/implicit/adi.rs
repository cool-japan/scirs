    ...
    pub fn solve(&self) -> PDEResult<ADIResult> {
        ...
        for step in 0..num_steps {
            ...
            if self.options.verbose && (step + 1) % 10 == 0 {
                println!("Step {}/{} completed, t = {:.4}", step + 1, num_steps, t_next);
            }
        }
