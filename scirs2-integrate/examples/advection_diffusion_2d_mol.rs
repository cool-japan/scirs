...
use scirs2_integrate::{
    BoundaryCondition, BoundaryConditionType, BoundaryLocation, Domain, MOL2DResult, MOLOptions,
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    .with_advection(
        ...
        |_x: f64, _y: f64, _t: f64, _u: f64| -> f64 { vx },
        // Advection in y-direction
        |_x: f64, _y: f64, _t: f64, _u: f64| -> f64 { vy },
    );
