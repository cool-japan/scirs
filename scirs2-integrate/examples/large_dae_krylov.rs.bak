...
use scirs2_integrate::{
    bdf_semi_explicit_dae, krylov_bdf_semi_explicit_dae, DAEIndex, DAEOptions, DAEResult, DAEType,
    IntegrateResult, ODEMethod,
};
...
fn constraint_equation(t: f64, u: ArrayView1<f64>, _lambda: ArrayView1<f64>) -> Array1<f64> {
