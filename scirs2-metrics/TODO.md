...
- SIMD acceleration (`optimization/hardware.rs`) only tracks x86/x86_64 feature flags (SSE2/AVX/AVX2/AVX-512); ARM NEON is still not tracked as of 0.6.2 despite once being slated for v0.4.0.
